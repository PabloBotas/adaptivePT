...
// FROM DIJ
    // Min dose in target:  42.3308 Gy
    // Mean dose in target: 60.2963 Gy
    // Max dose in target:  72.5383 Gy
    // 92.962 % above 90% prescription
    // 79.506 % above 95% prescription
    // 66.2788 % above 98% prescription
    // 54.1865 % above prescription
    // 26.4639 % above 105% prescription
    // 17.4232 % above 107% prescription
    // 9.2695 % above 110% prescription
    // 0.0381461 % above 120% prescription
// The adaptation process has the following dose levels in OARs:
//     Min dose:  0 Gy
//     Mean dose: 9.78504 Gy
//     Max dose:  67.3836 Gy
// FROM DOSE
//     Min dose in target:  42.5101 Gy
//     Mean dose in target: 60.6611 Gy
//     Max dose in target:  72.3477 Gy
//     93.7345 % above 90% prescription
//     81.4419 % above 95% prescription
//     69.4164 % above 98% prescription
//     57.8295 % above prescription
//     29.0673 % above 105% prescription
//     20.1793 % above 107% prescription
//     10.4711 % above 110% prescription
//     0.0286096 % above 120% prescription
// The adaptation process has the following dose levels in OARs:
//     Min dose:  0 Gy
//     Mean dose: 9.86019 Gy
//     Max dose:  69.2841 Gy
...
struct DoseStatsOARs : DoseStats {
    DoseStatsOARs (uint n_) : DoseStats(n_) {};
    void check_plan () {
